...
export ARCH=arm64
export KBUILD_BUILD_USER=lemezohaib
export KBUILD_BUILD_HOST=review.pixelos.net
export PATH="/home/zohaib/aosp/prebuilts/clang/host/linux-x86/clang-r563880c/bin/:$PATH"
